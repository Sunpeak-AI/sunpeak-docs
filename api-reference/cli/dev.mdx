...
<Info>
In a sunpeak project, run this command via your package manager: `pnpm dev`, `npm run dev`, or `yarn dev`.
</Info>
...
- All MCP Resources from `src/components/resources/*-resource.tsx`
