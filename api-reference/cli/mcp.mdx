...
Automatically discovers and serves all simulations from your resource folders:

- Scans each `src/resources/{name}/` folder for `*-simulation.json` files
- Creates MCP tools based on your simulation configuration
