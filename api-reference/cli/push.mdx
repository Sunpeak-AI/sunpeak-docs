...
<Info>
**Resource names must be unique within a repository.** If you push a resource with a name that already exists, it will update the existing resource. The resource name is derived from the `name` field in your `.json` file.
</Info>
