---
title: "MCP Server"
description: "Mock data MCP server for testing local Resources in the real ChatGPT."
---
...
<Steps>
  <Step title="Start the MCP server">
    ...
    It also watches your `src/` directory and automatically rebuilds on file changes.
  </Step>
  ...
  <Step title="Test your widget">
    Send `show carousel` or whatever you named your `Tool` in your `Simulation` to ChatGPT to see your simulation in action!
