...
```
  ...
  <Step title="Create simulation files">
    Create a resource folder with metadata and simulation files. Each resource lives in its own folder:

    ```json
    // src/resources/example/example-resource.json
    {
      "name": "example",
      "title": "Example",
    ...
    Create a simulation JSON file in the same folder:
